...
<html lang="en">
  <head>
    ...
    <title>Login Area | Lampung Pet Clinic</title>
  ...
  <body style="background: #2A3F54;font-family: 'Roboto Condensed';"  id="fakeLoader">
    <div class="container" style="text-align: center;margin-top: 100px">
          <h1 style="text-align: center;margin-bottom: 30px;color:#ffffff">Sistem Informasi Lampung Pet Clinic</h1>
          <br>
          <center><p>Institut Teknologi Sumatera </p></center>
